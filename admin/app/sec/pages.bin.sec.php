...
?>
	<div class="mg-sec container">
		<div class="gd-100">
			<div class="pd-zero gd-60 gd-m-100"><h1><span class="icon-file-text"></span> Páginas eliminadas</h1></div>
			<div class="pd-zero gd-40 gd-m-100 tx-right">
				<a href="<?php echo APP_ROOT; ?>/pages/create"><button type="button" class="btn btn-primary"><span class="icon-plus"></span></button></a>
			</div>
		</div>
			...
			<?php foreach( $lista as $c ): ?>
				<div class="container">
					...
					<div class="gd-20 gd-m-50 tx-right">
						<a href="<?php echo APP_ROOT; ?>/pages/update/<?php echo $c['id']; ?>"><button class="btn btn-primary size-s"><span class="icon-pencil"></span></button></a>
					</div>
				</div>
			<?php endforeach; ?>
			<?php if (!$lista): ?>
				<div class="alert">
				    <strong>¡Sin páginas!</strong> No se encontrarón resultados.
				</div>
			<?php endif; ?>
		</div>
	</div>
