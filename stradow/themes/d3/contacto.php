	...
	<div id="" class="pd-sec bg-blue">
		<div class="container cont-600">
			<div class="tx-center">
				...
				<p>Si te localizas en la ciudad de México podemos quedar en persona, si por el contrario te localizas en otra comunidad podemos hablar por teléfono o vía email.</p>
				<p>Para mandarnos un mensaje completa el formulario de contacto o escríbenos directamente a nuestro e-mail, te responderemos pronto.</p>
			</div>
		</div>
	</div>
	<div class="pd-sec">
		...
		<div class="s-icons tx-center">
			<a href="https://fb.com/debredweb"><span class="icon-facebook"></span> Facebook</a>
			<a href="https://twitter.com/@debredweb"><span class="icon-twitter"></span> Twitter</a>
			<a href="https://plus.google.com/u/0/+Debredweb"><span class="icon-google-plus"></span> Google+</a>
		</div>
	</div>
	<script>
